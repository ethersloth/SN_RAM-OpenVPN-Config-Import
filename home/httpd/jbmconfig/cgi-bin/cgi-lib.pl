...
# cgi-lib@pobox.com
# $Id: cgi-lib.pl,v 2.18a 1999/02/23 08:16:43 brenner Exp $
#
# 8/12/08 JBM/bet fix for FF3 and application/x-www-form-urlencoded
# v2.18a
#
#
#
...
$cgi_lib::maxdata    = 17825792;    # maximum bytes to accept via POST - 2^17
$cgi_lib::writefiles =      "/tmp/";    # directory to which to write files, or
